        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <div class="text-center">
                    ...
                    <a href="index.html"><h1 class="p-5">ADM</h1></a>
                    


                        <h1 class="p-5">Bonjour <?php echo $data['pseudo']; ?> !</h1>
                        <img style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover;" src="" id="imgPreview" alt="Preview">
                        <hr />
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="layouts/change_avatar.php" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="file" id="myFileInput" class="btn btn-success">
                                <br />
